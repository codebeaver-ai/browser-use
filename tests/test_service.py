...
class TestDomService:
    def test_create_selector_map(self):
        ...
        This test ensures that:
        1. The method processes the DOM tree correctly.
        2. Only elements with highlight indices are included in the map.
        3. The resulting map contains the correct mappings.
        """
        # Create a mock Page object
        mock_page = Mock()

        # Initialize DomService
        ...
        assert 2 not in selector_map  # child2 should not be in the map as it has no highlight_index